...
Aplicação backend desenvolvida seguindo os requisitos propostos logo abaixo pelo desafio 2 do bootcamp GoStack da Rocketseat.

Aplicação para armazenar repositórios do github, que irá permitir a criação, listagem, atualização e remoção dos repositórios, e além disso permitir que os repositórios possam receber "likes".
...
Para rodar a aplicação execute o comando `yarn dev` ou `npm run dev`
